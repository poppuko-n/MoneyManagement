## 概要
AI診断を用いた投資体験と家計簿機能を提供した、資産運用の第一歩をサポートするサービスです。
...
本プロダクトを通じて、投資をより身近に感じてもらい、社会的な「貯蓄から投資へ」を後押しすることで、個人の資産形成と経済成長の好循環を促し、より豊かな社会を実現することを目指しております。
...
- 仮想投資体験のみではなく、家計簿機能を提供することで、自身の支出状況を可視化し「自分ならこのくらい投資できそう」「もっと節約すべき」という気づきや意識改革を支援。
